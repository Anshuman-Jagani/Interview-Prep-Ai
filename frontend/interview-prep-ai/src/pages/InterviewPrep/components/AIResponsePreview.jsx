    ...
    return <div className='relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200'>
        <div className='flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200'>
            ...
            >
                ...
                {copied && (
                    <span className='absolute -top-8 right-0 bg-black text-white text-xs rounded-md p-2 py-1 opacity-80 group-hover:opacity-100 transition'>
                        Copied!
                    </span>
                )}
            </button>
        ...
        <SyntaxHighlighter
            language={language}
            style={oneLight}
            customStyle={{ fontSize: 12.5, margin: 0, padding: 'lrem', background: 'transperent' }}
        >
            {code}
        </SyntaxHighlighter>
    </div>
